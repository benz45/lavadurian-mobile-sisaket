            ...
            Flexible(
              child: Consumer2<BookBankModel, StoreModel>(
                builder: (_, bookBankModel, storeModel, __) {
                  ...
                  List listBookBank = bookBankModel.getBookBankFromStoreId(storeId: storeId);
                  return Column(
                        ...
                        itemBuilder: (_, index) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(width: 2, color: kPrimaryColor.withOpacity(.4)),
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: Text(
                                        ...
                                        style:
                                            TextStyle(color: kTextPrimaryColor, fontSize: textTheme.subtitle2.fontSize, fontWeight: FontWeight.bold),
                                      ),
                                    ),
                                    InkWell(
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => BookBankEditScreen(bookbankID: listBookBank[index]['id']),
                                          ),
                                        );
                                      },
                                      // * Edit button
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      'สาขา',
                                      style:
                                          TextStyle(color: kTextSecondaryColor, fontSize: textTheme.subtitle2.fontSize, fontWeight: FontWeight.bold),
                                    ),
                                    Text(
                                      '${listBookBank[index]['bank_branch']}',
                                      style: TextStyle(color: kPrimaryColor, fontSize: textTheme.subtitle2.fontSize, fontWeight: FontWeight.bold),
                                    ),
                                  ],
                                ),
                                //! Account type
                        ...
                        child: OutlineButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => BookBankAddScreen(storeID: storeId),
                              ),
                            );
                          },
                        ),
